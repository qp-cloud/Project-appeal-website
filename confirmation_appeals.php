...
$sql = "SELECT * FROM appeals WHERE user_id = '$user_id' ORDER BY id DESC LIMIT 1";
...
<body>
    <div class="container confirmation-container">
        ...
        <div class="complaint-info">
            ...
            <p><strong>หมวดหมู่:</strong> <?= htmlspecialchars($complaint['category']) ?></p>
            <p><strong>ชื่อผู้รายงาน:</strong> <?= htmlspecialchars($complaint['report_person']) ?></p>
            <p><strong>ช่องทางการติดต่อ:</strong> <?= htmlspecialchars($complaint['contact_phone']) ?></p>
            ...
            <p><strong>วันที่และเวลาที่เกิดเหตุ:</strong> <?= htmlspecialchars($complaint['incident_date']) ?>, <?= htmlspecialchars($complaint['incident_time']) ?></p>
            ...
            <p><strong>รายละเอียดการร้องเรียน:</strong> <?= htmlspecialchars($complaint['complaint_description']) ?></p>
